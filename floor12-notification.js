f12notification = {
    ...
    notification: function (content, type, timeout = 3000) {
    ...
    success: function (content, timeout = 3000) {
        this.notification(content, 1, timeout)
    },
    error: function (content, timeout = 3000) {
        this.notification(content, 2, timeout)
    },
    info: function (content, timeout = 3000) {
        this.notification(content, 0, timeout)
    },
...
function info(content, type, timeout = 3000) {
    ...
    return f12notification.notification(content, type, timeout);
}
